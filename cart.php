            ...
            <div class="row">
                <form action="checkout.php" method="post">
                    <div class="col-lg-12 col-custom">
                            ...
                            <table class="table table-bordered">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td class="pro-title"><a href="#">Jasmine Putih </a></td>
                                        <td class="pro-price"><span>Rp 93.000</span></td>
                                    ...
                                    <tr>
                                        ...
                                        <td class="pro-title"><a href="#">Anggrek Orange</a></td>
                                        <td class="pro-price"><span>Rp 93.000</span></td>
                                        <td class="pro-quantity">
                                            <div class="quantity">
                                                <div class="cart-plus-minus">
                                    ...
                                    <tr>
                                        ...
                                        <td class="pro-title"><a href="#">Daisy Merah</a></td>
                                        <td class="pro-price"><span>Rp 130.000</span></td>
                                        <td class="pro-quantity">
                                            <div class="quantity">
                                                <div class="cart-plus-minus">
                                    ...
                                    <tr>
                                        ...
                                        <td class="pro-title"><a href="#">Buket Rose Merah</a></td>
                                        <td class="pro-price"><span>Rp 130.000</span></td>
                                        <td class="pro-quantity">
                                            <div class="quantity">
                                                <div class="cart-plus-minus">
                        ...
                        <!-- Cart Update Option -->
                        <div class="cart-update-option d-block d-md-flex justify-content-center">
                            <div class="cart-update mt-sm-16">
                                <button type="submit" class="btn flosun-button primary-btn rounded-0 black-btn">Checkout Sekarang</button>
                            </div>
                        </div>
                </form>
            </div>
